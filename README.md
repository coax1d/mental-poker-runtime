...
The `mental-poker` protocol crate is included as a git submodule under `./mental-poker/`. Clone with submodules in one go:

```bash
git clone --recurse-submodules https://github.com/coax1d/mental-poker-runtime.git
```
